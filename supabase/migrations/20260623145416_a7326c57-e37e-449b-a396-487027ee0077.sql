...
INSERT INTO public.monitoring_alert_policies (
  monitor_key, monitor_label, owner_team, warning_channel, page_channel, warn_rule, page_rule, runbook_url
) VALUES
  ('cron_job_health','Cron Job Health','Platform / Ops','ops_email','pager',
  ...
  ('stripe_webhook_health','Stripe Webhook Health','Billing / Ops','ops_email','pager',
  ...
  ('email_deliverability','Email Deliverability','Platform / Ops','ops_email','pager',
  ...
  ('edge_function_health','Edge Function Health','Platform / Ops','ops_email','pager',
...
SET monitor_label = EXCLUDED.monitor_label,
