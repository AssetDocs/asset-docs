...
-- - Reconcile gift_subscriptions columns expected by edge functions/RPCs.
-- - Prevent gift redemption from overwriting an active paid/admin/lifetime entitlement.
-- - Normalize subscriber email writes.
-- - Add a safe cleanup function for abandoned pre-Stripe gift checkout rows.
