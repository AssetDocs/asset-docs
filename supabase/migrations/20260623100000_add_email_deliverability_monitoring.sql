...
SELECT
  ...
  stats.delayed_24h,
  CASE
    WHEN stats.sent_or_delivered_24h = 0 THEN NULL
    ELSE round((stats.bounced_24h::NUMERIC / stats.sent_or_delivered_24h::NUMERIC) * 100, 2)
  END AS bounce_rate_24h,
  CASE
    WHEN stats.sent_or_delivered_24h = 0 THEN NULL
    ELSE round((stats.complained_24h::NUMERIC / stats.sent_or_delivered_24h::NUMERIC) * 100, 2)
  ...
  CASE
    ...
    WHEN stats.sent_or_delivered_24h >= 20
      AND (stats.bounced_24h::NUMERIC / NULLIF(stats.sent_or_delivered_24h, 0)) >= 0.10
      THEN 'page'
    WHEN stats.complained_24h > 0 THEN 'warn'
    WHEN stats.sent_or_delivered_24h >= 20
      AND (stats.bounced_24h::NUMERIC / NULLIF(stats.sent_or_delivered_24h, 0)) >= 0.05
      THEN 'warn'
