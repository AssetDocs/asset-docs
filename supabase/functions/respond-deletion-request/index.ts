            ...
            <body style="font-family: Arial, sans-serif; line-height: 1.6; color: #333; max-width: 600px; margin: 0 auto; padding: 20px;">
              ...
              ${action === 'approve' ? `
                <div style="text-align: center; margin: 30px 0;">
                  <a href="https://getassetsafe.com/account" style="display: inline-block; background-color: #dc2626; color: white; padding: 12px 24px; text-decoration: none; border-radius: 6px; font-weight: bold;">Proceed with Deletion</a>
                </div>
              ` : ''}
