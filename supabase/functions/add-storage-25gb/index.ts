...
Deno.serve(async (req) => {
  ...
  try {
    console.log('[ADD-STORAGE-25GB] Function started');
    ...
    console.log('[ADD-STORAGE-25GB] User authenticated:', user.id);
    ...
    console.log('[ADD-STORAGE-25GB] Creating checkout session for 25GB storage add-on');

    // Create Stripe checkout session for 25GB storage add-on
    ...
    console.log('[ADD-STORAGE-25GB] Checkout session created:', session.id);
    ...
    console.error('[ADD-STORAGE-25GB] Error:', error);
    return new Response(
