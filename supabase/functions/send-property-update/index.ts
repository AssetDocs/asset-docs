          ...
          <div style="max-width: 600px; margin: 0 auto; padding: 20px;">
            ...
            <div style="background-color: #ffffff; padding: 30px; border-radius: 0 0 12px 12px; box-shadow: 0 4px 6px rgba(0,0,0,0.1);">
              ...
              <div style="margin-top: 20px; padding-top: 20px; border-top: 1px solid #eeeeee;">
                <a href="https://www.getassetsafe.com/properties" style="display: inline-block; background-color: #f97316; color: #ffffff; padding: 12px 24px; text-decoration: none; border-radius: 6px; font-weight: 500;">View Properties</a>
              </div>
            </div>
            <div style="text-align: center; padding: 20px; color: #888888; font-size: 12px;">
              ...
              <p>Manage your notification preferences in your <a href="https://www.getassetsafe.com/account" style="color: #f97316;">account settings</a>.</p>
            </div>
          </div>
        </body>
        </html>
