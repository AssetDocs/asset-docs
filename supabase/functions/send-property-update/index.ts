        ...
        <body style="font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, sans-serif; margin: 0; padding: 0; background-color: #f5f5f5;">
          <div style="max-width: 600px; margin: 0 auto; padding: 20px;">
            <div style="background: linear-gradient(135deg, #f97316 0%, #ea580c 100%); padding: 30px; border-radius: 12px 12px 0 0; text-align: center;">
              <img src="https://getassetsafe.com/lovable-uploads/asset-safe-logo-email-v2.jpg" alt="Asset Safe" style="max-width: 150px; margin-bottom: 15px;" />
            ...
            <div style="background-color: #ffffff; padding: 30px; border-radius: 0 0 12px 12px; box-shadow: 0 4px 6px rgba(0,0,0,0.1);">
              ...
              <div style="margin-top: 20px; padding-top: 20px; border-top: 1px solid #eeeeee;">
                <a href="https://getassetsafe.com/properties" style="display: inline-block; background-color: #f97316; color: #ffffff; padding: 12px 24px; text-decoration: none; border-radius: 6px; font-weight: 500;">View Properties</a>
              </div>
            </div>
            <div style="text-align: center; padding: 20px; color: #888888; font-size: 12px;">
              ...
              <p>Manage your notification preferences in your <a href="https://getassetsafe.com/account" style="color: #f97316;">account settings</a>.</p>
            </div>
          </div>
        </body>
        </html>
