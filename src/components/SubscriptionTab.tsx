          ...
          <div className="p-4 border rounded-lg bg-blue-50 border-brand-blue">
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-gray-600">$8.99/month • Billed monthly (Introductory Price)</p>
                <p className="text-sm text-gray-500">Next billing date: January 15, 2024</p>
                <p className="text-xs text-brand-orange font-medium">Regular price $12.99/month after 6 months</p>
              </div>
        ...
        <CardContent>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            <div className="p-4 border rounded-lg">
              ...
              <p className="text-2xl font-bold text-brand-blue">$8.99<span className="text-sm font-normal">/month</span></p>
            ...
            <div className="p-4 border-2 border-brand-blue rounded-lg bg-blue-50">
              ...
              <div className="mb-2">
                <p className="text-2xl font-bold text-brand-blue">$8.99<span className="text-sm font-normal">/month</span></p>
                <p className="text-xs text-brand-orange font-medium">6-month intro price (reg. $12.99)</p>
              </div>
              <ul className="mt-3 space-y-1 text-sm text-gray-600">
            ...
            <div className="p-4 border rounded-lg">
              ...
              <p className="text-2xl font-bold text-brand-blue">$18.99<span className="text-sm font-normal">/month</span></p>
              <ul className="mt-3 space-y-1 text-sm text-gray-600">
