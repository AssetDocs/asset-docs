      ...
      <div>
        ...
        <Accordion type="single" collapsible>
          ...
          <AccordionItem value="security-5">
            ...
            <AccordionContent>
              We offer step-by-step video tutorials and helpful resources in the References section of our website footer to guide you through the platform. You can also use "Ask Ashley" — our built-in chat assistant available 24/7 via the chat icon in the bottom-right corner of every page.
            </AccordionContent>
          </AccordionItem>
        </Accordion>
      </div>
