    ...
    <section className="py-20 bg-white">
      <div className="container mx-auto px-4">
        <div className="max-w-4xl mx-auto">
          <h2 className="text-4xl font-bold text-brand-blue mb-8 text-center">About Asset Docs</h2>
            ...
            <section className="mb-12">
              ...
              <div className="grid md:grid-cols-3 gap-8 mb-12">
                <div className="text-center p-6 bg-white rounded-lg shadow-md">
                  ...
                  <h4 className="text-xl font-semibold mb-3 text-gray-800">Simplify Protection</h4>
                ...
                <div className="text-center p-6 bg-white rounded-lg shadow-md">
                  ...
                  <h4 className="text-xl font-semibold mb-3 text-gray-800">Verified Claims</h4>
                  <p className="text-gray-600">
                ...
                <div className="text-center p-6 bg-white rounded-lg shadow-md">
                  ...
                  <h4 className="text-xl font-semibold mb-3 text-gray-800">Peace of Mind</h4>
                  <p className="text-gray-600">
