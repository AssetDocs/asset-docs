              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                <div className="bg-white p-6 rounded-lg shadow">
                  ...
                  <p className="text-gray-600">
                    Capture detailed images of your property and possessions with our mobile app or professional photography service. Our system automatically organizes and tags your photos for easy retrieval.
                  </p>
                </div>
