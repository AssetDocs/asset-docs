...
import { ArrowLeft, FileImage, Upload, Home } from 'lucide-react';
      ...
      <div className="flex-grow py-8 px-4 bg-gray-50">
        <div className="max-w-6xl mx-auto">
          <div className="mb-6">
            ...
            <h1 className="text-3xl font-bold text-brand-blue mb-2">Upload Floor Plans</h1>
            <p className="text-gray-600">Upload architectural drawings and floor plans of your property</p>
          </div>
