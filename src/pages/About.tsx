    ...
    <div className="flex flex-col min-h-screen">
      ...
      <div className="container mx-auto px-4 py-12 flex-grow">
        <div className="max-w-4xl mx-auto">
          <h1 className="text-4xl font-bold text-brand-blue mb-8 text-center">About AssetDocs</h1>
            ...
            <section className="mb-12">
              ...
              <div className="bg-gradient-to-r from-blue-50 to-teal-50 p-8 rounded-lg mb-8">
                <p className="text-xl text-gray-700 leading-relaxed text-center mb-6">
                  AssetDocs was born from a simple yet powerful belief: protecting your family's most valuable 
              ...
              <div className="bg-gray-50 p-8 rounded-lg">
                ...
                <p className="text-lg text-gray-700 leading-relaxed text-center mb-6">
                  ...
                  belongings are properly documented and protected. AssetDocs transforms the traditional, 
                ...
                <div className="bg-white p-6 rounded-lg border-l-4 border-brand-blue">
                  <p className="text-gray-700 italic text-center">
                    ...
                    you can prove what you've lost. With AssetDocs, you're not just documenting possessions—
