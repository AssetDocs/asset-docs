  ...
  const fetchAllAssets = async () => {
    ...
    try {
      ...
      const [
        ...
        supabase.from('user_documents').select('id, document_name, file_name, file_url, file_path, created_at').eq('property_id', propertyId).eq('user_id', user.id).eq('pending_delete', false).or('document_type.is.null,document_type.neq.floorplan'),
