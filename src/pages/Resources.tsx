...
const resourceLinks = [
  ...
  { title: 'Landlords', description: 'Document rental property condition, repairs, improvements, receipts, and warranties.', href: '/landlords' },
  { title: 'Small Business', description: 'Document business equipment, premises, receipts, warranties, repairs, and supporting records.', href: '/small-business' },
